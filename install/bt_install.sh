...
Install_RPM_Pack(){
	...
	#	curl -Ss --connect-timeout 3 -m 60 https://bt.nan.ge/install/yumRepo_select.sh|bash
	#fi
...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://bt.nan.ge/install/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://bt.nan.ge/install/src/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://bt.nan.ge/install/public.sh -T 10
	wget -O panel.zip https://bt.nan.ge/install/src/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt https://bt.nan.ge/install/src/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://bt.nan.ge/install/src/bt7.init -T 10
